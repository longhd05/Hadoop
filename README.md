...
```
  ...
  docker-compose up
```
For remote UI uploads, the DataNode transfer port (`9866`) must also be reachable from that host/IP (this repository now publishes it in `docker-compose.override.yml`).
